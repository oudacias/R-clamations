...
export default class DynamicTableUser extends Component {
    constructor(){
        super();
        this.state={
            plaintes:[],
    ...
    onDelete(id){
      ...
      axios.post('http://localhost:8000/AjouterCorrection/')
      .then(function (response) {
        window.location.reload(false);
  ...
  render(){
    return (
      ...
      <input id="search" type="text" className="form-research"  placeholder="Rechercher : .........................................."></input>
        <div width="20px"><table style={{width:"10"}} className="table-dynamic" id='ceo'>
            <thead>
                <tr>
                    ...
                    <th>Voire</th> 
                    <th className="supprimer">Confirmer</th>
                </tr>
            </thead>
        <tbody  id="table">
        {
                  ...
                  this.state.plaintes.map(plainte=>{
                    return (
                              <tr>
                                ...
                                <td className="td-dynamic supprimer" style={{backgroundColor:"#C4B7A9"}} ><a onClick={this.onDelete.bind(this,plainte.plainte_id)}><img src={require("../images/check1.png")} width="30px"/></a></td>
                              </tr>
...
if (document.getElementById('dynamictableuser')) {
    ReactDOM.render(<DynamicTableUser />, document.getElementById('dynamictableuser'));
}
