...
export default class DynamicShort extends Component {
    constructor(){
        super();
        this.state={
            plaintes:[],
    ...
    componentDidMount(){
      $("#search").on("keyup", function() {
        ...
        axios.get('http://localhost:8000/listPlainteShort')
        .then(response=>{
...
if (document.getElementById('dynamicshort')) {
    ReactDOM.render(<DynamicShort />, document.getElementById('dynamicshort'));
}
